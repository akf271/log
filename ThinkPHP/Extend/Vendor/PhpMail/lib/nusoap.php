<?php
if(!defined('Li_Ming')) exit('Access Denied');
/*
...
/*require_once('http://127.0.0.7/include/lib/class.soapclient.php');
require_once('./include/lib/class.soap_val.php');
require_once('./include/lib/class.soap_parser.php');
require_once('./include/lib/class.soap_fault.php');

// transport classes
require_once('./include/lib/class.soap_transport_http.php');

// optional add-on classes
require_once('./include/lib/class.xmlschema.php');
require_once('./include/lib/class.wsdl.php');

// server class
require_once('./include/lib/class.soap_server.php');
*/
