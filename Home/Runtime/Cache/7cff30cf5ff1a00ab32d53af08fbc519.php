...
<script type="text/javascript" src="/Public/Js/Saccount/changebshoppsw.js"></script>
</head>
  ...
  <div class="DivMainRight">
    <div class="h80">
      <ul class="breadcrumb ">
        ...
        <li><a style="font-weight:bold" href="javascript:void(0);">重置密码</a></li> <!--<span class="divider">/</span></li>
        <li class="active">Data</li>-->
      </ul>
    </div>
    <div class="content">
      <div class="blank40"></div>
      <div class="alert alert-info"> <br />重置账号：<?php echo ($memberInfo["username"]); ?><br />
        <br />
        </div>
      <form id="changeBshopPswForm" class="form-horizontal">
      <input type="hidden" name="shopid" value="<?php echo ($shopid); ?>" />
        <div class="control-group">
          ...
          <div class="controls">
            ...
            <span class="help-inline help-inline2 " id="passwordTip"></span> </div>
        </div>
        <div class="control-group">
          <label class="control-label" for="inputPasswordConfirm">确认新密码：</label>
          <div class="controls">
            <input type="password" id="inputPasswordConfirm" placeholder="密码" name="passwordConfirm">
            <span class="help-inline help-inline2 " id="passwordConfirmTip"></span> </div>
        </div>
        <div class="control-group">
          <label class="control-label" for="inputEmail">验证码： </label>
          <div class="controls"> <img id="verifyImg" onclick="this.src='/public/logicverify/?id='+Math.random()*5;" src="/public/logicverify/" style="cursor:pointer;">
            <input style=" width:35px; margin-right:5px;" type="text" id="verify" placeholder="" name="verify" >
            <a id="changeVerify" href="javascript:void(0);">看不清换一张</a></div>
        </div>
        <div class="control-group">
          <div class="controls">
           
            <button id="changeBshopPswFormButton" type="button" class="btn">确定重置</button>
          </div>
        </div>
      </form>
      <div class="blank40"></div>
