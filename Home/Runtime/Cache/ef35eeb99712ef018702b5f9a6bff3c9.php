...
<script src="/Public/Js/Saccount/thelist.js"></script>
</head>
...
<div class="divGlobal margin">
  ...
  <div class="DivMainRight">
    <div class="h80">
      <ul class="breadcrumb ">
        <li class="blank40"></li>
        <li><a href="/saccount/thelist"  style="font-weight:bold">子账号管理</a> <!--<span class="divider">/</span>--></li>
        <!-- <li><a href="#">Library</a> <span class="divider">/</span></li>
        <li class="active">Data</li>-->
      </ul>
      <div style="position:absolute; right:80px; top:160px"><a href="/saccount/add" type="submit" role="button" class="btn"> 添加子账号</a> </div>
    </div>
    <div class="content">
      <table class="table table-hover">
        ...
        <tbody>
            ...
            <!--<td><a class="money_a"  href="javascript:void(0);" shopid="<?php echo ($data["userid"]); ?>"><?php echo ($data["money"]); ?></a> </td>-->
            <td><?php echo ($data["money"]); ?></td>
            <?php if(($data["status"] == 0)): ?><td><a class="operate_a" href="javascript:void(0);" shopid="<?php echo ($data["userid"]); ?>">操作</a> </td><?php else: ?><td>冻结 | <a href="javascript:void(0);" id="startUseUser" shopid="<?php echo ($data["userid"]); ?>">启用</a></td><?php endif; ?>
