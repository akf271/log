...
<div class="divGlobal margin">
  ...
  <div class="DivMainRight">
    <div class="h80">
      <ul class="breadcrumb ">
        <li class="blank40"></li>
        <li><a style="font-weight:bold" href="/distributemoney/bshoprecord">总店拨款记录</a> <!--<span class="divider">/</span></li>
    ...
    <div class="content">
      ...
      <table class="table table-hover">
        <thead>
          <tr>
            <th class="h20">操作时间</th>
            <th class="h20">操作流水号</th>
            <th class="h20">类型</th>
            <th class="h20">金额</th>
            <th class="h20">&nbsp;</th>
            <th class="h20">&nbsp;</th>
