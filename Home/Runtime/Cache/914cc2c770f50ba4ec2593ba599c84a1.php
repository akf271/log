...
<script type="text/javascript" src="/Public/Js/Distributemoney/reducebshopmoney.js"></script>
</head>
...
<div class="divGlobal margin">
  ...
  <div class="DivMainRight">
    <div class="h80">
      <ul class="breadcrumb ">
        <li class="blank40"></li>
        <li><a href="/distributemoney"  >代充金额分配</a> <span class="divider">/</span></li>
        <li><a style="font-weight:bold" href="javascript:void(0);">减少额度</a></li> <!--<span class="divider">/</span></li>
    ...
    <div class="content">
      ...
      <form class="form-horizontal" id="reduceBshopMoneyForm">
      <input type="hidden" name="shopid" value="<?php echo ($shopid); ?>" />
    
        <div class="control-group">
          <label class="control-label" for="inputmoney">减少额度值：</label>
          <div class="controls">
            <input type="text"  name="money" id="inputmoney" placeholder="减少额度值" onkeyup="javascript: var myreg=/^[+]?(([1-9]\d*[.]?)|(0.))(\d{0,2})?$/;if(!myreg.test(this.value)){this.value=''; }; "> 元
        ...
        <div class="control-group">
          <div class="controls">
            <!--<label class="checkbox">
              <input type="checkbox">
              我已阅读并同意相关服务条款 </label>-->
            <button type="button" id="reduceBshopMoneyButton" class="btn">确定增加</button>
          </div>
        </div>
      </form>
      <div class="blank40"></div>
